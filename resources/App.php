...
class App
{
     ...
     * @return void
     */
    public static function init(string $routePath, string $constantsPath, string $accessPath, string $databasePath, string $validationPath) :void
    {
        date_default_timezone_set('Asia/Samarkand');

        Router::init($routePath);
        BaseController::init($constantsPath, $accessPath);
